...
zims_dir = os.environ.get("ZIMS_DIR", "/config/storage/zims")
...
accent_color = os.environ.get("ACCENT_COLOUR", "default")
...
node_title = os.environ.get("NODE_NAME", "🬧 The NomadNet Encyclopedia")
